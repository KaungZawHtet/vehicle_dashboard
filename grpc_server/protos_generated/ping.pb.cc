...
const uint32_t TableStruct_ping_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::vehicle::HelloRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::vehicle::HelloRequest, _impl_.name_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::vehicle::HelloReply, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::vehicle::HelloReply, _impl_.message_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::vehicle::HelloRequest)},
  { 7, -1, -1, sizeof(::vehicle::HelloReply)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::vehicle::_HelloRequest_default_instance_._instance,
  &::vehicle::_HelloReply_default_instance_._instance,
};

const char descriptor_table_protodef_ping_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\nping.proto\022\007vehicle\"\034\n\014HelloRequest\022\014\n"
  "\004name\030\001 \001(\t\"\035\n\nHelloReply\022\017\n\007message\030\001 \001"
  "(\t2C\n\007Greeter\0228\n\010SayHello\022\025.vehicle.Hell"
  "oRequest\032\023.vehicle.HelloReply\"\000B\006\242\002\003HLWb"
  "\006proto3"
  ;
...
HelloRequest::HelloRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:vehicle.HelloRequest)
}
HelloRequest::HelloRequest(const HelloRequest& from)
  ...
  // @@protoc_insertion_point(copy_constructor:vehicle.HelloRequest)
}
...
HelloRequest::~HelloRequest() {
  // @@protoc_insertion_point(destructor:vehicle.HelloRequest)
...
// @@protoc_insertion_point(message_clear_start:vehicle.HelloRequest)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "vehicle.HelloRequest.name"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* HelloRequest::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:vehicle.HelloRequest)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:vehicle.HelloRequest)
  return target;
}

size_t HelloRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:vehicle.HelloRequest)
  size_t total_size = 0;
...
void HelloRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:vehicle.HelloRequest)
...
// @@protoc_insertion_point(class_specific_copy_from_start:vehicle.HelloRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
HelloReply::HelloReply(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:vehicle.HelloReply)
}
HelloReply::HelloReply(const HelloReply& from)
  ...
  // @@protoc_insertion_point(copy_constructor:vehicle.HelloReply)
}
...
HelloReply::~HelloReply() {
  // @@protoc_insertion_point(destructor:vehicle.HelloReply)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:vehicle.HelloReply)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "vehicle.HelloReply.message"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* HelloReply::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:vehicle.HelloReply)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:vehicle.HelloReply)
  return target;
}

size_t HelloReply::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:vehicle.HelloReply)
  size_t total_size = 0;
...
void HelloReply::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:vehicle.HelloReply)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:vehicle.HelloReply)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::vehicle::HelloRequest*
Arena::CreateMaybeMessage< ::vehicle::HelloRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::vehicle::HelloRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::vehicle::HelloReply*
Arena::CreateMaybeMessage< ::vehicle::HelloReply >(Arena* arena) {
  return Arena::CreateMessageInternal< ::vehicle::HelloReply >(arena);
}
