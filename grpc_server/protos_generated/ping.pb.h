...
PROTOBUF_NAMESPACE_OPEN
template<> ::vehicle::HelloReply* Arena::CreateMaybeMessage<::vehicle::HelloReply>(Arena*);
template<> ::vehicle::HelloRequest* Arena::CreateMaybeMessage<::vehicle::HelloRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace vehicle {
...
class HelloRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:vehicle.HelloRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:vehicle.HelloRequest)
 private:
  class _Internal;
...
class HelloReply final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:vehicle.HelloReply) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:vehicle.HelloReply)
 private:
  class _Internal;
...
inline const std::string& HelloRequest::name() const {
  // @@protoc_insertion_point(field_get:vehicle.HelloRequest.name)
...
void HelloRequest::set_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:vehicle.HelloRequest.name)
}
inline std::string* HelloRequest::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:vehicle.HelloRequest.name)
  return _s;
}
...
inline std::string* HelloRequest::release_name() {
  // @@protoc_insertion_point(field_release:vehicle.HelloRequest.name)
...
inline void HelloRequest::set_allocated_name(std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:vehicle.HelloRequest.name)
}
...
inline const std::string& HelloReply::message() const {
  // @@protoc_insertion_point(field_get:vehicle.HelloReply.message)
...
void HelloReply::set_message(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:vehicle.HelloReply.message)
}
inline std::string* HelloReply::mutable_message() {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:vehicle.HelloReply.message)
  return _s;
}
...
inline std::string* HelloReply::release_message() {
  // @@protoc_insertion_point(field_release:vehicle.HelloReply.message)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:vehicle.HelloReply.message)
}
